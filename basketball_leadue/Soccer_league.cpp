...
Date* Soccer_league::checkDate(string data)
{
...
void Soccer_league::readFromFile(fstream& file , vector<Team*>& _team , vector<Game*>& _game ,int &_isOpen)
{
...
void Soccer_league::readUserFileAction(char* dbS , char* outputS , char* userS)
{
...
void Soccer_league::set_isOpen(int num)
{
	_isOpen = num;
}

int Soccer_league::get_isOpen()
{
	return _isOpen;
}
...
vector<Game*> Soccer_league::get_games()
{
	return get_games();
}

//add a new line into the data base
void Soccer_league::writeToFileinTheEnd(string line, fstream& file)
{
	League::writeToFileinTheEnd(line, file);
}

void Soccer_league::writeToOUTPUTfile(string line, fstream& file)
{
	League::writeToOUTPUTfile(line,file);
}

//add a new line into the data base
void Soccer_league::writeToFileinTheMiddel(string line, fstream& file)
{
...
DataBase* Soccer_league::get_dataBase()
{
	return _dateBase;
}
...
//print league table
void Soccer_league::printLeagueTabel(vector<Team*>_team)
{
	League::printLeagueTabel(_team);
}

//sort the table
void Soccer_league::sortTable (vector<Team*>_team)
{
	League::sortTable(_team);
}

//change line in the file if they macth
void Soccer_league::replace_line_in_file(string search_string , string replace_string,fstream& file,vector<Team*>& _team , vector<Game*> &_game)
{
	League::replace_line_in_file( search_string ,  replace_string, file, _team , _game);
}

void Soccer_league::addGame(string line,fstream&file, vector<Game*>_game)
{
	League::addGame(line,file,_game);
}

void Soccer_league::removeLine (string line , fstream& file)
{
	League::removeLine(line,file);
}

void Soccer_league::updateGameDetails(string home,string guest, string score,fstream& file,vector<Team*>_team ,vector<Game*>_game)
{
	League::updateGameDetails(home,guest,score,file,_team,_game);
}

void Soccer_league::updateGame(string gameNumber,string date, fstream& file,vector<Team*>_team,vector<Game*>_game )
{
	League::updateGame(gameNumber,date, file,_team,_game);
}

string Soccer_league:: getGameDetails(int i,vector<Game*>_game)
{
	/*
...
string Soccer_league:: getFullGameDetails(Game * game)
{
	/*
	ostringstream convert;   // stream used for the conversion
	convert << Number;      // insert the textual representation of 'Number' in the characters in the stream
...
string Soccer_league:: getFullGameDetails(int i,vector<Game*>_game)
{
