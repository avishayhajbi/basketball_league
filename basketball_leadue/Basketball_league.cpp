...
Date* Basketball_league::checkDate(string data)
{
...
void Basketball_league::readFromFile(fstream& file , vector<Team*>& _team , vector<Game*>& _game ,int &_isOpen)
{
	League::readFromFile( file ,  _team , _game ,_isOpen);
}

//controll the program navigation
void Basketball_league::start(string str)
{
...
void Basketball_league::readUserFileAction(char* userS,char* dbS , char* outputS)
{
...
void Basketball_league::writeToFileinTheEnd(string line, fstream& file)
{
	League::writeToFileinTheEnd(line, file);
}

void Basketball_league::writeToOUTPUTfile(string line, fstream& file)
{
	League::writeToOUTPUTfile(line,file);
}

//add a new line into the data base
void Basketball_league::writeToFileinTheMiddel(string line, fstream& file)
{
	League::writeToFileinTheMiddel(line,file);
}

//interpret the team status into my vareables
void Basketball_league::interpretGamesToTeamsStatus(vector<Team*>_team ,Game* game)
{
...
//print league table
void Basketball_league::printLeagueTabel(vector<Team*>_team)
{
	League::printLeagueTabel(_team);
}

//sort the table
void Basketball_league::sortTable (vector<Team*>_team)
{
	League::sortTable(_team);
}

//change line in the file if they macth
void Basketball_league::replace_line_in_file(string search_string , string replace_string,fstream& file,vector<Team*>& _team , vector<Game*> &_game)
{
	League::replace_line_in_file( search_string ,  replace_string, file, _team , _game);
}

void Basketball_league::addGame(string line,fstream&file, vector<Game*>_game)
{
	League::addGame(line,file,_game);
}

void Basketball_league::removeLine (string line , fstream& file)
{
	League::removeLine(line,file);
}

void Basketball_league::updateGameDetails(string home,string guest, string score,fstream& file,vector<Team*>_team ,vector<Game*>_game)
{
	League::updateGameDetails(home,guest,score,file,_team,_game);
}

void Basketball_league::updateGame(string gameNumber,string date, fstream& file,vector<Team*>_team,vector<Game*>_game )
{
	League::updateGame(gameNumber,date, file,_team,_game);
}

string Basketball_league:: getGameDetails(int i,vector<Game*>_game)
{
	/*
...
string Basketball_league:: getFullGameDetails(int i,vector<Game*>_game)
{
